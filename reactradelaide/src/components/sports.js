      ...
      return (
        <div>
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>Local football results of games.</CardText>
            <CardActions border>
              <Button
                colored
                target="_blank"
      ...
      return (
        <div>
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>Local soccer results and updates.</CardText>
            <CardActions border>
              <Button
                colored
                target="_blank"
      ...
      return (
        <div>
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>Local club results of competitions.</CardText>
            <CardActions border>
              <Button
                colored
                target="_blank"
      ...
      return (
        <div>
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>Local racing events at Mallala and The Bend.</CardText>
            <CardActions border>
              <Button
                colored
                target="_blank"
      ...
      return (
        <div>
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>Local results of games.</CardText>
            <CardActions border>
              <Button
                colored
                target="_blank"
